...
public class RecordPanel extends JPanel {
	...
	public RecordPanel(RhythmTyping rhythmTyping) {
		...
		int[] x= {0,640,0,640};
		int[] y= {0,0,300,300};
		String[] songTitle= {"강남스타일 - PSY", "D - 딘","빨간맛 - 레드벨벳", "삐딱하게 - GD"};
		for(int i=0;i<4;i++) {
		...
		songScrollPanel.setBorder(new LineBorder(new Color(255, 50, 50, 50),2));
		...
		for(int j =0;j<RhythmTyping.score[i].length;j++) {
			...
			JLabel score=new JLabel("점수     :  "+RhythmTyping.score[i][j]);
