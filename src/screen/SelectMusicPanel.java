...
//	JButton[] goButton = new JButton[4];
	...
	public SelectMusicPanel(RhythmTyping rhythmTyping) {
		...
		musicListPanel.setHorizontalScrollBarPolicy(ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
		...
		musicListPanel.setBounds(0, 100,Main.SCREEN_WIDTH, 570);//Main.SCREEN_WIDTH
