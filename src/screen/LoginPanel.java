...
public class LoginPanel extends JPanel {
	...
	public LoginPanel(RhythmTyping rhythmTyping) {
		...
		id_label.setFont(new Font("맑은고딕",Font.PLAIN, 20));
		add(id_label);
		...
		pw_label.setFont(new Font("맑은고딕",Font.PLAIN, 20));
		add(pw_label);
		...
		name_label.setFont(new Font("맑은고딕",Font.PLAIN, 20));
		add(name_label);
